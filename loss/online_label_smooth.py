"""
Implementation from: https://github.com/ankandrew/online-label-smoothing-pt/blob/main/ols/online_label_smooth.py
"""
import torch
...
class OnlineLabelSmoothing(nn.Module):
    """
    Implements Online Label Smoothing from paper: "Delving Deep into Label Smoothing"
    https://arxiv.org/pdf/2011.12562.pdf
    """

    def __init__(self, alpha: float = 0.5, n_classes: int = 689, smoothing: float = 0.1):
        """
        ...
        # for the training of the loss set to default_true
        self.training = True
