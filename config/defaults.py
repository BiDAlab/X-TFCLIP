...
_C.DATALOADER.NUM_INSTANCE_LIST = [30, 10, 8]  # list instead of int
...
_C.SOLVER.STAGE2.IMS_PER_BATCH_LIST = [90, 30, 18]
# Name of optimizer
...
_C.SOLVER.STAGE2.RES_STEPS = [30, 30, 30]  # added this

# Layerwise learning rate
_C.SOLVER.STAGE2.LR_LAYER_DECAY = True
_C.SOLVER.STAGE2.LR_LAYER_DECAY_RATE = 0.9
_C.SOLVER.STAGE2.LR_LAYER_DECAY_MAX_LAYER = 11
