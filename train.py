...
from loss.make_loss_ols import make_loss
...
if __name__ == '__main__':
    #############################################
    # --> ĺŠ č˝˝ĺŹ‚ć•°ĺ’Śĺťĺ§‹ĺŚ–
    #############################################
    parser = argparse.ArgumentParser(description="ReID Baseline Training")
    parser.add_argument(
        "--config_file", default="configs/vit_clipreid_288x144_higher_batch.yml", help="path to config file", type=str
    )
    ...
    optimizer_2stage, optimizer_center_2stage = make_optimizer_2stage(cfg, model, loss_func.center_criterion)
