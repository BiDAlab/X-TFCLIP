...
def make_optimizer_1stage(cfg, model):
    ...
    # Collect parameters from the prompt learner
    params = []
    ...
    # Sanity check
    if len(params) == 0:
        raise ValueError("No trainable parameters found for Stage 1. Check model structure and flags.")

    # Create the optimizer
    if cfg.SOLVER.STAGE1.OPTIMIZER_NAME == 'SGD':
        optimizer = torch.optim.SGD(params, lr=cfg.SOLVER.STAGE1.BASE_LR,
